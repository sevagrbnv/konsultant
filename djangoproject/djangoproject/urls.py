...
from docs.views import DocDetailView, DocListView, FileUploadView, FileDownloadView, ZipDownloadView, DecisionDataView
...
urlpatterns = [
    ...
    path('docs/decision_data/', DecisionDataView.as_view(), name='decision-data'),
